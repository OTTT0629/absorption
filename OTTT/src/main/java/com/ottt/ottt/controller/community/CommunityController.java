...
public class CommunityController {
	...
	public String freecommunity(Model m, HttpServletRequest request, HttpSession session, String toURL) throws Exception {
		...
		*/
		...
		//아티클 총건수 가져오기
    	m.addAttribute("totalCount" , communityService.getArticleTotalCount(null));
	...
	public List<ArticleDTO> getArticleList(ArticleSearchDTO dto) throws Exception {
		logger.info(":::: ajax 호출 입니다.:::: ");
		return communityService.getArticleList(dto);
	}
