...
public class NotificationController {
	...
	public String alarm(Model m, HttpSession session) {
		...
		try {
			List<NotificationDTO> notiList = notificationService.getNotiList(userDTO.getUser_no());
			int notiCnt = notificationService.notificationCnt(userDTO.getUser_no());
			int notiCheckCnt = notificationService.getSelectCheck(userDTO.getUser_no());

			m.addAttribute("notiCnt", notiCnt);
			m.addAttribute("notiCheckCnt", notiCheckCnt);
			m.addAttribute("notiList", notiList);
