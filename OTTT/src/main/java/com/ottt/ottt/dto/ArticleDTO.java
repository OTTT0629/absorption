...
public class ArticleDTO {
	...
	private String	article_create_dt;
	private String	article_mod_dt;
	...
	public String getArticle_create_dt() {
		return article_create_dt;
	}


	public void setArticle_create_dt(String article_create_dt) {
		this.article_create_dt = article_create_dt;
	}


	public String getArticle_mod_dt() {
		return article_mod_dt;
	}


	public void setArticle_mod_dt(String article_mod_dt) {
